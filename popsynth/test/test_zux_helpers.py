...
@given(
    st.floats(min_value=0.01,), st.floats(min_value=0.01,),  st.integers(min_value=1, max_value=1000)
)
...
@given(
    st.floats(), st.floats(min_value=0.01,),  st.integers(min_value=1, max_value=1000)
)
